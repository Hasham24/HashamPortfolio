      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center" ref={containerRef}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
            <a
              href="mailto:ahmadhasham702@gmail.com"
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                ahmadhasham702@gmail.com
              </p>
            </a>

            <a
              href="https://github.com/hasham24"
              className="glass-morphism rounded-xl p-6 text-center hover-lift"
              target="_blank"
              rel="noopener noreferrer"
            >
              ...
              <p className="text-sm text-muted-foreground">Ahmad Hasham</p>
            </a>

            <a
              href="https://www.linkedin.com/in/ahmadhasham/"
              className="glass-morphism rounded-xl p-6 text-center hover-lift"
              target="_blank"
              rel="noopener noreferrer"
            >
